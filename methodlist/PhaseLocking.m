classdef PhaseLocking < NeuroMethod & NeuroPlot.NeuroPlot
    ...
    methods
        ...
        %% method for NeuroPlot
          ...
          function obj=Changefilemat(obj,filemat,varargin)
            global Result Eventdescription Channeldescription SPKdescription Channellist Channelpanel t FilePath Fs matvalue Blacklist Eventpanel Eventlist Spikepanel Spikelist Classpath
            tmpobj=findobj(obj.NP,'Tag','Matfilename');
    ...
    methods(Access='private')
        function Resultplotfcn(obj)
                global  t Fs Spikepanel Eventpanel Channelpanel
                obj.saveblacklist(Channelpanel.parent,Spikepanel.parent,Eventpanel.parent);
                [Resultoutput, binnedraster, binnedspike]=obj.GetPhaseLocking(Channelpanel,Spikepanel,Eventpanel);
