classdef EVTData< BasicTag & dynamicprops
    %EVTDATA event data management in NEURODATA object
    % event data file is the text contains two column
    % time/description format：
    % time1 description1
    % time2 description2
    % ... ...
    % time description header format:
    % [time] [description] [a] [b] .....
    % time1 description1 a1 b1 ....
    % time2 description2 a2 b2 ....
    %... ... ... ... ....
    ...
    methods (Access='public')
        ...
        function obj = initialize(obj)
         ...
         function obj=LoadEVT(obj)
             ...
             % EVTdata.selectevent is generated by NeuroMethod.getParams
             % See also: NEUROMETHOD.GETPARAMS
