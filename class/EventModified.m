   ...
   % correct the choosed eventtype according to the Video     
    ...
    methods
       function obj=getParams(obj,timetype)
        ...
        function VideoCorrectGUI(obj,Videodata,DetailsAnalysis)
        ...
        function Eventmodifycreate(obj,parent,DetailsAnalysis)
            import NeuroPlot.selectpanel
             [~, ~,eventdescription,eventselect]=obj.Eventdata.LoadEVT(DetailsAnalysis);
             ...
             Eventlist=num2cell(eventselect);
